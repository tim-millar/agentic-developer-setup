...
CLAUDE_EXPLORE_RUNTIME_VERSION=2
...
CLAUDE_EXPLORE_SANDBOX_ENABLED=true
CLAUDE_EXPLORE_SANDBOX_FAIL_IF_UNAVAILABLE=true
CLAUDE_EXPLORE_SANDBOX_ALLOW_UNSANDBOXED_COMMANDS=false
CLAUDE_EXPLORE_SANDBOX_FILESYSTEM_DISABLED=false
CLAUDE_EXPLORE_DISABLE_ALL_HOOKS=true
CLAUDE_EXPLORE_DISABLE_ARTIFACT=true
CLAUDE_EXPLORE_STRICT_MCP_CONFIG=true
CLAUDE_EXPLORE_CHROME_ENABLED=false
...
CLAUDE_EXPLORE_GIT_ENV='GIT_CONFIG_PARAMETERS
GIT_CONFIG_COUNT
GIT_CONFIG_GLOBAL
GIT_CONFIG_SYSTEM
GIT_DIR
...
GIT_EXEC_PATH
GIT_NAMESPACE'
CLAUDE_EXPLORE_GIT_ENV_PREFIXES='GIT_CONFIG_KEY_
GIT_CONFIG_VALUE_'
...
PGSERVICE
PGSERVICEFILE'
CLAUDE_EXPLORE_PSQL_FORCED_ARGS='-X'
CLAUDE_EXPLORE_PSQL_PASSWORD_FILE_NAME=pgpass
