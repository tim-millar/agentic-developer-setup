...
class FrameworkValidator
  ...
  def validate_repository_structure
    required_files = %w[AGENTS.md REVIEW.md README.md framework.yml .ruby-version Gemfile Gemfile.lock lefthook.yml docs/AGENT_PROMPT.txt scripts/run_codex.sh scripts/agent_host_env.sh .github/PULL_REQUEST_TEMPLATE.md]
